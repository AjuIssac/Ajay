...
public class ExtentedReports {
	...
	public void beforetest() {
		...
		reporter=new ExtentHtmlReporter("./Reporter/myreport.html");
		...
		public void buttontest() throws IOException{
			...
			String buttontest=driver.findElement(By.xpath("//*[@id=\"u_0_5_5C\"]")).getText();
		...
		public void logotest() throws IOException{
			...
			boolean logotest=driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div/div[1]/div/img")).isDisplayed();
        ...
        public void browserclose(ITestResult result) throws IOException{
        	if(result.getStatus()==ITestResult.FAILURE) {
        		...
        		String screenshot=ExtentedReports.screenshotMethod(driver,result.getName());
